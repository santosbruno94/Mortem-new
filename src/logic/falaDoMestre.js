...
import { ehJanelaPrecisa } from './veredicto.js';
...
// "Precisa" é o MESMO predicado do veredicto (fonte única): ajustar lá
// ajusta aqui, e o mestre nunca assina o que o tribunal rejeita.
const janelaPrecisa = ehJanelaPrecisa;
