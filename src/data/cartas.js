...
export const CARTAS = [
  ...
  },
  {
    ...
    descricao:
      'A cinza sobe acima das barras: cinza pálida que se levanta ao mínimo sopro, lâminas negras encurvadas que estilhaçam em vez de vincar, uma crosta curva e rígida, em camadas. Posta a vela ao rés da grelha, as lâminas devolvem um brilho de linhas paralelas, e entre as linhas outras marcas de brilho, sem forma que se leia. No resto do leito, um fecho de latão com a sua chapa, escurecido e torto, um fio de linho preso a uma dobra de folhas queimadas e, de encontro às barras, um pedaço de pasta empenada: o pano do forro torrado, e por baixo dele um carvão da grossura da própria pasta, que se descama em placas.',
