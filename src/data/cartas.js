...
export const CARTAS = [
  ...
  },
  {
    ...
    descricao:
      'A cinza sobe acima das barras: cinza pálida que se levanta ao mínimo sopro, lâminas negras encurvadas que estilhaçam em vez de vincar, uma crosta espessa em camadas. Posta a vela ao rés da grelha, as lâminas devolvem um brilho de linhas paralelas, e entre as linhas outras marcas de brilho, sem forma que se leia. No resto do leito, um fecho de latão com a sua chapa, escurecido e torto, um fio de linho preso a uma dobra de folhas queimadas e, de encontro à grade, um pedaço de pasta empenada: a pele torrada, e por baixo dela um carvão de vários milímetros que se descasca em placas.',
